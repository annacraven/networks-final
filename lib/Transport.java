...
public class Transport {
    ...
    public static final int SERVER_HELLO = 5;
    public static final int SERVER_AUTHENTICATE = 6;
    public static final int CLIENT_HANDSHAKE_FINISHED = 7;
    public static final int SERVER_HANDSHAKE_FINISHED = 8;
